...
<div class="group-bookings-list">
	...
	<?php foreach($group_bookings as $group_booking){ ?>
		<div class="gb-booking" <?php echo OsBookingHelper::quick_booking_btn_html($group_booking->id); ?>>
			...
			<div class="gbb-customer">
				...
				<?php if ($group_booking->livesmart_visitor_url) { ?>
					<br/>
			        <div class="gbb-meeting"><span class="latepoint-btn ">
			        	<a style="color:white;text-decoration:none;    padding: 5px 5px;" href="<?php echo $group_booking->livesmart_visitor_url; ?>" target="_blank"><?php _e('Join Meeting', 'latepoint'); ?></a></span></div>
				<?php } ?>
			</div>
  ...
  <div class="os-add-box add-booking-to-group-box" <?php echo OsBookingHelper::quick_booking_btn_html(false, ['start_time'=> $group_booking->start_time, 
    ...
    <div class="add-box-label"><?php _e('New Appointment', 'latepoint'); ?></div>
  </div>
</div>