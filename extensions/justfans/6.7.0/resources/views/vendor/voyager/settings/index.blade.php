            ...
            <div class="panel">
                ...
                <div class="page-content settings container-fluid">
                    <ul class="nav nav-tabs">
                        ...
                        <li @if($group === $active && $active === 'LiveSmart') class="active" @endif>
                            <a data-toggle="tab" href="#livesmart">LiveSmart Settings</a>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content">
                        ...
                        <!-- LiveSmart Settings -->
                        <div id="livesmart" class="tab-pane fade in @if($group == $active && $active === 'LiveSmart') active @endif">

                            <div class="kind-of-a-form-control">

                                <div class="panel-heading setting-row setting-theme_livesmart" data-settingkey="livesmart_url">
                                    <h3 class="panel-title">
                                        LiveSmart Settings
                                    </h3>
                                </div>
                                <div class="panel-body no-padding-left-right setting-row setting-theme_livesmart" data-settingkey="livesmart_url">
                                    <div class="col-md-12 no-padding-left-right">
                                        <input type="text" class="form-control livesmart_url_field" name="livesmart_url" placeholder="LiveSmart Server URL" value="{{getSetting('livesmart.url') ? getSetting('livesmart.url') : ''}}">
                                    </div>
                                </div>
