...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary float-left" data-localize="payment_history"></h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            ...
            <table class="table table-bordered" id="history_table" width="100%" cellspacing="0">
                <thead>
                    <tr>
                        <th class="text-center" data-localize="payment_id"></th>
                        ...
                        <th class="text-center" data-localize="plan"></th>
                    </tr>
                </thead>
                <tbody>
